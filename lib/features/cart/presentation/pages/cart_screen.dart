            ...
            if (books.isEmpty) {
              return Center(
                child: Column(
                  ...
                  children: [
                    SvgPicture.asset(AppImages.cartsvg, height: 100, colorFilter: ColorFilter.mode(AppColors.primaryColor, BlendMode.srcIn)),
                    Gap(10),
            ...
            return ListView.separated(
              itemBuilder: (BuildContext context, int index) {
                return CartCard(
                  ...
                  onDelete: () {
                    cubit.removeCart(cartItemId: books[index].itemId ?? 0);
                  },
                  onUpdate: (q) {
                    cubit.updateCart(cartItemId: books[index].itemId ?? 0, quantity: q);
                  },
                );
              },
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Spacer(),
                      Text('₹${cubit.cartResponse?.data?.total ?? 0}', style: TextStyles.styleSize20()),
                    ],
                  ),
                  Gap(13),
