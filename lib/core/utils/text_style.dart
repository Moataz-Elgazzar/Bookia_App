...
class TextStyles {
  static TextStyle styleSize30({Color? color, double? fontSize, FontWeight? fontWeight}) {
    return TextStyle(color: color, fontSize: 30, fontWeight: FontWeight.normal);
  }

  static TextStyle styleSize26({Color? color, double? fontSize, FontWeight? fontWeight}) {
  ...
  static TextStyle styleSize18({Color? color, double? fontSize, FontWeight? fontWeight}) {
    return TextStyle(color: color, fontSize: 18, fontWeight: FontWeight.normal);
  }

  static TextStyle styleSize16({Color? color, double? fontSize, FontWeight? fontWeight}) {
    return TextStyle(color: color, fontSize: 16, fontWeight: FontWeight.normal);
  }

  static TextStyle styleSize14({Color? color, double? fontSize, FontWeight? fontWeight}) {
    return TextStyle(color: color, fontSize: 14, fontWeight: FontWeight.normal);
  }

  static TextStyle styleSize12({Color? color, double? fontSize, FontWeight? fontWeight}) {
